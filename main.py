...
def attack(char_name: str, char_class: str) -> str:
    """Функция урона в зависимости от класса.
    attack(char_name, char_class) -> str
    Параметры:
    char_name -- тип <str> Имя персонажа
    char_class -- тип <str> Класс персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Функция блока в зависимости от класса.
    defence(char_name, char_class) -> str
    Параметры:
    char_name -- тип <str> Имя персонажа
    char_class -- тип <str> Класс персонажа.
    """
...
def special(char_name: str, char_class: str) -> str:
    """Функция специального умения класса.
    special(char_name, char_class) -> str
    Параметры:
    char_name -- тип <str> Имя персонажа
    char_class -- тип <str> Класс персонажа.
    """
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    start_training(char_name, char_class) -> str
    Параметры:
    char_name -- тип <str> Имя персонажа
    char_class -- тип <str> Класс персонажа.
    """
